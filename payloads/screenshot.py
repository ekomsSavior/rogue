...
try:
    ...
    ImageGrab = pyautogui = None
    print("[!] PIL/pyautogui not installed - run: pip install pillow pyautogui", file=sys.stderr)
...
if __name__ == "__main__":
    if ImageGrab is None or pyautogui is None:
        print("[!] screenshot requires pillow + pyautogui (pip install pillow pyautogui) - cannot run on this host")
        sys.exit(1)
